...
if (nativFilter) {
  ...
  if (array_filter_x_esm_isWorking) {
    ...
    if (array_filter_x_esm_doc) {
      ...
      array_filter_x_esm_res = attempt.call(fragment.childNodes, nativFilter, function (item) {
        array_filter_x_esm_newArrowCheck(this, array_filter_x_esm_this);
  ...
  if (array_filter_x_esm_isWorking) {
    ...
    array_filter_x_esm_res = attempt(Function('nativFilter', 'spy', 'castBoolean', fn), nativFilter, spy);
