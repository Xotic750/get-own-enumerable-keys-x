...
var assert_is_function_x_node_modules_is_primitive = __webpack_require__(8);
...
function dist_is_function_x_esm_isFunction(value, allowClass) {
  if (assert_is_function_x_node_modules_is_primitive_default()(value)) {
    return false;
  }
...
function assertIsFunction(callback) {
  if (dist_is_function_x_esm_isFunction(callback) === false) {
    var msg = assert_is_function_x_node_modules_is_primitive_default()(callback) ? to_string_symbols_supported_x_esm_toStringSymbolsSupported(callback) : '#<Object>';
...
if (nativFilter) {
  var spy = 0;
  var array_filter_x_esm_res = attempt_x_esm_attempt.call([1, 2], nativFilter, function (item) {
  ...
  if (array_filter_x_esm_isWorking) {
    spy = '';
    array_filter_x_esm_res = attempt_x_esm_attempt.call(array_filter_x_esm_castObject('abc'), nativFilter, function (item, index) {
      array_filter_x_esm_newArrowCheck(this, array_filter_x_esm_this);
  ...
  if (array_filter_x_esm_isWorking) {
    spy = 0;
    array_filter_x_esm_res = attempt_x_esm_attempt.call(function getArgs() {
      /* eslint-disable-next-line prefer-rest-params */
      return arguments;
  ...
  if (array_filter_x_esm_isWorking) {
    spy = 0;
    array_filter_x_esm_res = attempt_x_esm_attempt.call({
      0: 1,
      1: 2,
      3: 3,
      4: 4,
  ...
  if (array_filter_x_esm_isWorking) {
    ...
    if (array_filter_x_esm_doc) {
      ...
      array_filter_x_esm_res = attempt_x_esm_attempt.call(fragment.childNodes, nativFilter, function (item) {
        array_filter_x_esm_newArrowCheck(this, array_filter_x_esm_this);
  ...
  if (array_filter_x_esm_isWorking) {
    ...
    if (isStrict) {
      spy = null;
      array_filter_x_esm_res = attempt_x_esm_attempt.call([1], nativFilter, function () {
        array_filter_x_esm_newArrowCheck(this, array_filter_x_esm_this);
  ...
  if (array_filter_x_esm_isWorking) {
    ...
    array_filter_x_esm_res = attempt_x_esm_attempt(Function('nativFilter', 'spy', 'castBoolean', fn), nativFilter, spy);
...
if (node_modules_has_symbol_support_x_dist_has_symbol_support_x_esm && nativeGOPS && typeof nativeGOPS === 'function') {
  ...
  var get_own_property_symbols_x_esm_r = attempt_x_dist_attempt_x_esm_attempt(nativeGOPS, get_own_property_symbols_x_esm_testObj);
...
/* harmony default export */ var get_own_enumerable_property_symbols_x_node_modules_has_symbol_support_x_dist_has_symbol_support_x_esm = (node_modules_has_symbol_support_x_dist_has_symbol_support_x_esm_hasSymbolSupport.threw === false && node_modules_has_symbol_support_x_dist_has_symbol_support_x_esm_hasSymbolSupport.value === true);


// EXTERNAL MODULE: ./node_modules/get-own-enumerable-property-symbols-x/node_modules/is-primitive/index.js
var get_own_enumerable_property_symbols_x_node_modules_is_primitive = __webpack_require__(6);
...
/* harmony default export */ var node_modules_has_to_string_tag_x_dist_has_to_string_tag_x_esm = (get_own_enumerable_property_symbols_x_node_modules_has_symbol_support_x_dist_has_symbol_support_x_esm &&
/* eslint-disable-next-line compat/compat */
is_symbol_default()(Symbol.toStringTag));
...
var dist_to_primitive_x_esm_symToPrimitive = get_own_enumerable_property_symbols_x_node_modules_has_symbol_support_x_dist_has_symbol_support_x_esm && Symbol.toPrimitive;
/* eslint-disable-next-line compat/compat */

var dist_to_primitive_x_esm_symValueOf = get_own_enumerable_property_symbols_x_node_modules_has_symbol_support_x_dist_has_symbol_support_x_esm && Symbol.prototype.valueOf;
...
function to_property_key_x_esm_toPropertyKey(argument) {
  ...
  return get_own_enumerable_property_symbols_x_node_modules_has_symbol_support_x_dist_has_symbol_support_x_esm && to_property_key_x_esm_typeof(key) === 'symbol' ? key : to_string_x_dist_to_string_x_esm_ToString(key);
}
...
function property_is_enumerable_x_esm_propertyIsEnumerable(object, property) {
  return property_is_enumerable_x_esm_propIsEnumerable.call(toObject(object), to_property_key_x_esm_toPropertyKey(property));
}
...
function getOwnEnumerablePropertySymbols(target) {
  ...
  return array_filter_x_esm(getOwnPropertySymbols(object), function (symbol) {
    ...
    return property_is_enumerable_x_esm_propertyIsEnumerable(object, symbol);
  }.bind(this));
}
